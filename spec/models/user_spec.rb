...
describe User do
    ...
    it { should respond_to(:followers) }
		...
		describe "Accessible admin" do
			it "should not allow to access admin" do
				expect do
					User.new(admin: true)
	...
	describe "when the email format is invalid" do
		it "should be invalid" do
			addresses = %w[user@gmail,com the_user@hotmail. user_at_foo.org first_last@skype+line.com]
	...
	describe "when the mail format is valid" do
		it "should be valid" do
			addresses = %w[user@gmail.com the_user@hotmail.com user@foo.org first+last@skypeline.com]
	...
	describe "email addresses with mixed case" do
		let(:mixed_case_email) {"FooBarHoge@eXample.CoM"}
